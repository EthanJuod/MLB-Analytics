...
private:
    ...
    Timeline mTimeline;
    /// Machines of the picture
    std::vector<std::shared_ptr<MachineDrawable>> mMachines;
public:
    Picture();
    ...
    */
    ...
    void AddMachine(std::shared_ptr<MachineDrawable> machine);

    /**
     * Getter for mMachines.
     * @return mMachines
     */
    std::vector<std::shared_ptr<MachineDrawable>> GetMachines() { return mMachines; }

    /**
     * Getter for a certain spot in mMachines
     * @param index
     * @return
     */
    std::shared_ptr<MachineDrawable> GetMachine(int index) { return mMachines[index]; }
};
